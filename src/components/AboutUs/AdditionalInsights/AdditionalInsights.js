...
export default function AdditionalInsights(){
    return(
        <div className="additional-insights">
            ...
            <p>KEABI Africa Community Development and Human Rights Organization (KACDHRO) continues to work toward building an Africa where everyone has the chance to live a life of dignity, peace, and opportunity.</p>
        </div>
    )
}